...
const TEXTS = {
  ...
  adminOrderBundleLine: (phone) => `묶음배송 대표번호: ${phone}`,
  ...
  // 2026-08-16: 묶음배송 — 직장동료 등과 같은 배송지·같은 날짜로 받을 때, 대표
  // 전화번호를 맞춰 입력하면 택배비를 면제해주는 기능. 다른 옵션들과 함께
  // 앞단계(용지선택 화면, 명함수량 아래)에서 고르도록 옮겼습니다.
  bundleShippingTitle: "묶음배송",
  bundleShippingFreeLabel: "택배비무료",
  bundleShippingDesc: "동료분과 같이 주문하시면서 같은 배송지로 같은 날짜에 받으시길 원하신다면 무료배송 서비스를 받으실 수 있습니다. 대표 전화번호를 정하시고 그 전화번호를 동료분에게 알려주시면 됩니다.",
  bundleShippingPhoneLabel: "대표 전화번호",
  bundleShippingPhonePlaceholder: "대표 전화번호를 입력해주세요",
    ...
    <div className="app-body" style={{ paddingBottom: 190 }}>
      ...
      <div style={{ padding: "6px 18px 4px" }}>
        ...
        <Card style={{ marginBottom: 16 }}>
          ...
          <div style={{ fontSize: 11.5, color: "var(--ink-soft)", lineHeight: 1.6, marginBottom: 10 }}>{TEXTS.bundleShippingDesc}</div>
